...
public class ShootTargetIO extends SubsystemBase {
  ...
  public Rotation2d angleToTarget(Translation2d currentPose) {
    return m_target.toTranslation2d().minus(currentPose).getAngle();
  }

  public double distanceToTarget(Translation2d currentPose) {
    return m_target.toTranslation2d().minus(currentPose).getNorm();
  }
